    ...
    <div className="flex flex-col items-center justify-center text-center mt-16 mb-7 bg-[#FAFAFA] pt-3">
      ...
      <div className="hidden sm:flex justify-center items-start gap-6 mt-6">
        ...
        <div className="relative">
          <Image src={"/card1.png"} alt="men" width={509} height={500} />
        ...
        <div className="relative">
          <Image src={"/card2.png"} alt="women" width={240} height={500} />
          <div className="absolute bottom-4 left-4 w-[170px] h-[48px] bg-white flex items-center justify-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative">
            <Image src={"/card3.png"} alt="accessories" width={240} height={242} />
            <div className="absolute bottom-4 left-4 w-[170px] h-[48px] bg-white flex items-center justify-center">
          ...
          <div className="relative">
            <Image src={"/card4.png"} alt="kids" width={240} height={242} />
            <div className="absolute bottom-4 left-4 w-[170px] h-[14px] bg-white flex items-center justify-center">
